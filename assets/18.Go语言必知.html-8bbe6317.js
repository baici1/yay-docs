import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as d,o as s,c as l,a as i,b as a,f as r,d as v}from"./app-12e502b6.js";const c={},t=v(`<h1 id="go-语言源码目录说明" tabindex="-1"><a class="header-anchor" href="#go-语言源码目录说明" aria-hidden="true">#</a> Go 语言源码目录说明</h1><blockquote><p>当你想要去看一个项目的源码时候，第一步应该先了解它的目录结构。</p></blockquote><h2 id="目录总览" tabindex="-1"><a class="header-anchor" href="#目录总览" aria-hidden="true">#</a> 目录总览</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="api" tabindex="-1"><a class="header-anchor" href="#api" aria-hidden="true">#</a> api</h3><p>该目录中的每个文件都是 <code>Go</code> 语言 <code>API</code> 列表，每行一个，方便 <code>IDE</code> 使用。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>.
├── except.txt
├── go1.1.txt
├── go1.10.txt
├── go1.11.txt
...
├── next.txt
└── README
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><ul><li>README：说明文件，里面有对该目录下文件作用的说明</li><li>except.txt：列举了接下来可能会废弃的 API，但是并不影响兼容问题</li><li>go*.txt：囊括了每个版本的 API 列表，文件内容只增不减，版本发布后就归档不再改动</li><li>next.txt：列举了未来的版本可能实现的新功能</li></ul><h2 id="src" tabindex="-1"><a class="header-anchor" href="#src" aria-hidden="true">#</a> src</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── archive #归档文件处理库，可以用来处理tar与zip类型文件。
...
└── vendor
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="cmd" tabindex="-1"><a class="header-anchor" href="#cmd" aria-hidden="true">#</a> cmd</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├── addr2line #因为linux上才支持这个命令，所以这里做了一个模拟器，用来支持pprof的
├── api #用于生成Go语言API列表
├── asm #汇编器，将源文件汇编为目标文件
...
├── vendor #Go语言包依赖工具
└── vet #代码静态检查工具
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="参考文章" tabindex="-1"><a class="header-anchor" href="#参考文章" aria-hidden="true">#</a> 参考文章</h2>`,13),m={href:"https://mp.weixin.qq.com/s/vJ-Z1tDmMVdrAyn-SZ0KLA",target:"_blank",rel:"noopener noreferrer"};function u(o,b){const n=d("ExternalLinkIcon");return s(),l("div",null,[t,i("p",null,[i("a",m,[a("超详细Go语言源码目录说明"),r(n)])])])}const h=e(c,[["render",u],["__file","18.Go语言必知.html.vue"]]);export{h as default};
